...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='LECO for VisDA-C')
    ...
    parser.add_argument('--dset', type=str, default='visda', choices=['clef','visda', 'office', 'office-home', 'com-dn'])
    ...
    parser.add_argument('--method', type=str, default='LECO',help='smoothness loss',choices=['NC', 'LECO', 'ENT', 'Blank'])

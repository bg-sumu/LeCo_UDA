...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='LECO for Office-Home')
    ...
    parser.add_argument('--dset', type=str, default='office-home', choices=['clef','visda', 'office', 'office-home', 'com-dn'])
    parser.add_argument('--lr', type=float, default=1e-2, help="learning rate")
    parser.add_argument('--net', type=str, default='resnet50', help="alexnet, vgg16, resnet50, res101,resnet34")
